...
(function(jwplayer) {
	...
	html5.player = function(config) {
		...
		function _initializeAPI() {
			...
			_this.jwGetDuration = function() { return _this._duration; }
            ...
            _this.jwSetDuration = function(val){ _this._duration = val; return _this._duration; };
            _this.jwSetTimeOffset = function(val){ _this._timeOffset = val; return _this._timeOffset; };
            _this.jwGetTimeOffset = function() { return _this._timeOffset; }
        ...
        /** Setters **/
        function _statevarFactorySet(statevar) {
			return function(val) {
				_model[statevar] = val;
                return _model[statevar];
			};

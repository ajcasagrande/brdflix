...
(function(jwplayer, undefined) {
	...
	var api = jwplayer.api = function(container) {
        ...
        _this.setDuration = function(duration) {
            return _callInternal('jwSetDuration', duration);
        };
        _this.setTimeOffset = function(offset) {
            return _callInternal('jwSetTimeOffset', offset);
        };
        _this.getTimeOffset = function() {
            return _callInternal('jwGetTimeOffset');
        };
        _this.setEstimatedBytes = function(offset) {
            return _callInternal('jwSetEstimatedBytes', offset);
        };
        _this.getEstimatedBytes = function() {
            return _callInternal('jwGetEstimatedBytes');
        };

	...
	public class JavascriptAPI {
		...
		protected function setupJSListeners():void {
			try {
                ...
                ExternalInterface.addCallback("jwSetDuration", js_setDuration);
                ExternalInterface.addCallback("jwSetTimeOffset", js_setTimeOffset);
                ExternalInterface.addCallback("jwGetTimeOffset", js_getTimeOffset);
                ExternalInterface.addCallback("jwSetEstimatedBytes", js_setEstimatedBytes);
                ExternalInterface.addCallback("jwGetEstimatedBytes", js_getEstimatedBytes);
		...
		protected function js_getDuration():Number {
			return _player.playlist.currentItem ? _player.playlist.currentItem.duration : _player.config.runtime;
		}
        
        protected function js_setDuration(val:Number):void {
			if (_player.playlist.currentItem){ _player.playlist.currentItem.duration = val };
            _player.config.runtime = val;
		}
        
        protected function js_getTimeOffset():Number {
			return _player.config.timeOffset;
		}
        
        protected function js_setTimeOffset(val:Number):void {
			_player.config.timeOffset = val;
		}
        
        protected function js_getEstimatedBytes():Number {
			return _player.config.estimatedBytes;
		}
        
        protected function js_setEstimatedBytes(val:Number):void {
			_player.config.estimatedBytes = val;
		}
